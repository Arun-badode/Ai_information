        ...
        <div className="container">
          <div className="row align-items-center justify-content-between mb-1">
            ...
            <div className="col-12 col-md-6 mb-4 mb-md-0 pe-md-4">
              ...
              <p>
                LawGeex is a cutting-edge AI-powered contract review platform that utilizes
                advanced machine learning algorithms to automate and streamline the contract
                management process. It is designed to assist legal professionals and businesses
                by providing faster, more accurate contract reviews, reducing human error, and
                ensuring compliance. By automating routine contract review tasks, LawGeex
                enhances the productivity of legal teams, helping them focus on more complex
                tasks and strategic decisions. The platform is widely used by enterprises, law
                firms, in-house legal teams, and SMBs to manage their contract review processes
                efficiently. LawGeex handles contract analysis, redlining, and ensures
                compliance with regulations while identifying risks. Its easy integration into
                existing legal workflows makes it a practical choice for many organizations.
              </p>
              <div className="mb-3">
                <a
