...
<section style={{ backgroundColor: "", padding: "3rem 0" }}>
  <div className="container text-center">
    <p className="text-primary">Chat with Multiple AIs in 3 Easy Steps</p>
    <h2
      style={{
        fontWeight: "semibold",
        color: "#fff",
    ...
    <div className="row g-4">
      ...
      <div className="col-md-4">
        ...
        >
          ...
          <p style={{ color: "#fff", margin: 0 }}>
            Select from top models like ChatGPT, Claude, and more—all in one place with Poe.
          </p>
      ...
      <div className="col-md-4">
        ...
        >
          ...
          <p style={{ color: "#fff", margin: 0 }}>
            Chat naturally with your selected AI to get instant answers, insights, or content.
          </p>
      ...
      <div className="col-md-4">
        ...
        >
          ...
          <p style={{ color: "#fff", margin: 0 }}>
            Switch between models, refine your queries, and find the best response from any AI.
          </p>
