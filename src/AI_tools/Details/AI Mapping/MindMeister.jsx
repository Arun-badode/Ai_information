        ...
        <div className="container">
          <div className=" row d-flex align-items-center justify-content-between mb-1">
            ...
            >
              ...
              <p>
                MindMeister AI is a powerful tool designed to enhance
                productivity and creativity. It combines the art of mind mapping
                with artificial intelligence, making it a great tool for
                brainstorming, project management, task management, and team
                collaboration. Whether you’re planning a project, organizing
                ideas, or creating workflows, MindMeister provides a
                comprehensive solution with its easy-to-use interface and
                AI-powered features.
              </p>
          ...
          <div className="bg-primary text-center text-light rounded-4 p-5 mt-5">
            <h4 className="mb-3">Ready to get started with MindMeister?</h4>
            <p className="mb-4">
