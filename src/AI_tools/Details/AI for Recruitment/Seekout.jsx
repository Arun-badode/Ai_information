      ...
      <div className="bg-dark text-light min-vh-100 py-5">
        <div className="container">
          <div className=" row d-flex align-items-center justify-content-between mb-1">
            ...
            >
              ...
              <p>
                SeekOut AI is a powerful AI-powered recruitment platform that
                helps organizations optimize their talent sourcing, candidate
                engagement, and hiring processes. Designed for both small
                businesses and large enterprises, SeekOut leverages artificial
                intelligence and machine learning to automate the recruitment
                process, enhance candidate discovery, and improve candidate
                matching.
              </p>

              <p>
                Unlike traditional recruiting methods, SeekOut AI uses advanced
                algorithms and predictive analytics to identify the best
                candidates across multiple platforms and engage with them in a
                personalized way. The platform can source passive candidates,
                search diverse talent pools, and integrate seamlessly with your
                existing ATS and CRM systems, making it an end-to-end solution
        ...
        `}
          ...
          <div className="bg-primary text-center text-light rounded-4 p-5 mt-5">
            <h4 className="mb-3">Ready to get started with Seekout AI?</h4>
            <p className="mb-4">
