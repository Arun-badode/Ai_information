      ...
      <div className="bg-dark text-light min-vh-100 py-5">
        <div className="container">
          <div className=" row d-flex align-items-center justify-content-between mb-1">
            ...
            >
              ...
              <p>
                SummarizeBot is an AI-powered summarization tool designed to
                condense long-form content into concise summaries. Leveraging
                sophisticated natural language processing (NLP) algorithms, this
                tool provides users with the ability to automatically summarize
                articles, documents, research papers, blog posts, and other text
                content. Whether you're a student, researcher, content creator,
                or business professional, SummarizeBot simplifies your workflow
                by saving you time and improving productivity.
              </p>
        ...
        `}</style>
          ...
          <div className="bg-primary text-center text-light rounded-4 p-5 mt-5">
            <h4 className="mb-3">Ready to get started with Scholarcy?</h4>
            <p className="mb-4">
