        ...
        return (
          <div className="row g-4">
            <div className="col-md-6">
              <img
                src="https://d8uzp82hd82jh.cloudfront.net/storage/tools/animoto/screenshot.webp"
                alt=""
            ...
            <div className="col-md-6">
              <img
                src="https://blog.ishosting.com/hs-fs/hubfs/blog/animoto-review/animoto-blog.png?width=883&height=500&name=animoto-blog.png"
                className="img-fluid rounded-3  w-100 h-100 object-fit-cover"
              />
            </div>
          </div>
      ...
      <div className="bg-dark text-light min-vh-100 py-5">
        <div className="container">
          ...
          <div className="bg-primary text-center text-light rounded-4 p-5 mt-5">
            <h4 className="mb-3">Ready to get started with Animoto?</h4>
            <p className="mb-4">
