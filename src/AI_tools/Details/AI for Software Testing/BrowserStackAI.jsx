...
import browserstack from '../../../../public/assets/Img/AI for software testing/browserstack.png'
import browserstack1 from '../../../../public/assets/Img/AI for software testing/browserstack1.png'
import browserstack2 from '../../../../public/assets/Img/AI for software testing/browserstack2.png'
// review section data
const reviews = [
  {
    name: "Alex Johnson",
...
const BrowserStackAI = () => {
            ...
            <div className="row g-4">
              <div className="col-12">
                <div className="custom-card text-light p-5 text-center">
                  ...
                  >
                    <li className="mb-3">
                      <strong>Efficiency:</strong> Automates repetitive tasks like cross-browser and device testing, reducing manual workload and increasing overall test efficiency.
                    </li>
                    <li className="mb-3">
                      <strong>Wide Browser Support:</strong> Enables testing across a broad range of browsers and devices to ensure consistent application performance.
                    </li>
                    <li className="mb-3">
                      <strong>Enhanced Accuracy:</strong> AI-driven intelligence targets the most failure-prone areas, improving the precision and value of test outcomes.
                    </li>
                    <li className="mb-3">
                      <strong>Seamless Integration:</strong> Easily integrates with tools like Selenium, Jenkins, and others to support smooth CI/CD workflow adoption.
                    </li>
                    <li className="mb-3">
                      <strong>Real-Time Test Results:</strong> Delivers immediate feedback to help identify and fix issues faster within the development cycle.
                    </li>
                  </ul>
            ...
            <div className="row justify-content-center gap-2">
              ...
              >
                ...
                <ul className="ps-3" style={{ listStyleType: "disc" }}>
                  <li className="mb-2">
                    <strong>Automated Testing:</strong> Automates browser and mobile testing, drastically reducing manual effort and saving time.
                  </li>
                  <li className="mb-2">
                    <strong>Cross-Platform Testing:</strong> Offers support for a wide range of browsers and devices across desktop and mobile platforms.
                  </li>
                  <li className="mb-2">
                    <strong>Seamless Selenium Integration:</strong> Integrates smoothly with Selenium and other popular testing tools, enhancing test workflows.
                  </li>
                  <li className="mb-2">
                    <strong>Real-Time Feedback:</strong> Delivers instant test results, enabling faster detection and resolution of issues.
                  </li>
                  <li className="mb-2">
                    <strong>Cloud-Based:</strong> Provides scalable and flexible infrastructure without local setup requirements.
                  </li>
                  <li className="mb-2">
                    <strong>AI-Enhanced Testing:</strong> Uses AI to prioritize high-risk areas, optimizing test coverage and efficiency.
                  </li>
                </ul>
              </div>
              ...
              >
                ...
                <ul className="ps-3" style={{ listStyleType: "disc" }}>
                  <li className="mb-2">
                    <strong>Learning Curve:</strong> New users may require time to fully integrate the tool into their workflows.
                  </li>
                  <li className="mb-2">
                    <strong>Subscription-Based Pricing:</strong> Can be costly for small teams or individual developers.
                  </li>
                  <li className="mb-2">
                    <strong>Limited Manual Testing:</strong> Manual testing capabilities may be less advanced compared to dedicated manual testing tools.
                  </li>
                  <li className="mb-2">
                    <strong>Cloud Dependency:</strong> Requires stable internet connectivity and does not support offline testing.
                  </li>
                  <li className="mb-2">
                    <strong>Customization Limits:</strong> May not provide sufficient flexibility for highly complex or customized test scenarios.
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="container my-5">
            ...
            <div className="row justify-content-center gap-2">
              ...
              >
                <ul className="ps-3" style={{ listStyleType: "disc" }}>
                  <li className="mb-2">
                    <strong>Sauce Labs</strong>: Cloud-based platform for cross-browser testing, mobile app testing, and Selenium/Appium automation with strong CI/CD integrations.
                  </li>
                  <li className="mb-2">
                    <strong>LambdaTest</strong>: Cloud testing platform offering manual and automated testing across thousands of browsers, devices, and OS combinations.
                  </li>
                  <li className="mb-2">
                    <strong>TestingBot</strong>: Provides Selenium and Cypress-based automated testing on a wide range of real browsers and mobile devices.
                  </li>
                  <li className="mb-2">
                    <strong>HeadSpin</strong>: Offers real device cloud, AI-based performance monitoring, and cross-platform testing for mobile and web apps.
                  </li>
                </ul>
              </div>
            </div>
  ...
  <div className="row align-items-center g-4 g-lg-5 mb-4">
    ...
    <div className="col-lg-6 col-md-12 order-2 order-lg-1 pe-lg-5">
      <p className="text-primary mb-2 fw-semibold">Write better, faster</p>
      <h1 className="display-5 mb-3">BrowserStack AI</h1>
      <div className="text-warning mb-3 fs-5">⭐⭐⭐⭐⭐</div>
      <p className="lead mb-4">
        BrowserStack AI is a powerful AI-driven browser testing tool that helps developers and QA teams perform automated testing across different browsers, devices, and operating systems.
      </p>
      <p className="mb-4">
        It integrates seamlessly with popular frameworks like Selenium, making it easy to scale testing efforts for web applications. By leveraging AI and machine learning, BrowserStack AI enhances the accuracy and speed of cross-browser testing, ensuring that web applications work consistently across all platforms.
      </p>
          ...
          <section style={{ backgroundColor: "", padding: "3rem 0" }}>
            ...
            `}
                    ...
                    <p style={{ color: "#fff", margin: 0 }}>
                      Automatically test your web applications across multiple browsers (Chrome, Firefox, Safari, etc.) without having to manually configure each one.
                    </p>
            ...
            `}
                    ...
                    <p style={{ color: "#fff", margin: 0 }}>
                      Test your application on a variety of mobile devices and operating systems, ensuring it functions well on Android, iOS, and desktop devices.
                    </p>
            ...
            `}
                    ...
                    <p style={{ color: "#fff", margin: 0 }}>
                      Use BrowserStack AI with Selenium for enhanced test automation, enabling you to run tests efficiently in real-time and on cloud infrastructure.
                    </p>
