      ...
      <div className="bg-dark text-light min-vh-100 py-5">
        <div className="container">
          <div className=" row d-flex align-items-center justify-content-between mb-1">
            ...
            >
              ...
              <p>
                ...
                transfer, and more—without requiring any coding knowledge. It is
                especially known for its text-to-video model Gen-2, offering
                next-level creativity with minimal input.
              </p>
          ...
          <div className="bg-primary text-center text-light rounded-4 p-5 mt-5">
            <h4 className="mb-3">Ready to get started with RunwayMLAI?</h4>
            <p className="mb-4">
