      ...
      <div className="bg-dark text-light min-vh-100 py-5">
        <div className="container">
          <div className=" row d-flex align-items-center justify-content-between mb-1">
            ...
            >
              ...
              <p>
                ClipDrop AI is an AI-powered photo editing and image enhancement
                tool that offers an array of advanced features like automatic
                background removal, object detection, image upscaling, and
                portrait enhancement. It is designed to make photo editing
                faster and more accessible by using AI to automate complex
                tasks, such as removing backgrounds, enhancing image quality,
                and improving facial features. Whether you're a professional
                photographer, e-commerce seller, content creator, or just
                someone who wants to make their photos look better, ClipDrop AI
                is a powerful tool that can significantly improve your workflow.
              </p>
              <p>
                It is ideal for anyone looking to automate tedious editing tasks
                while producing professional-quality results in minutes.
                ClipDrop AI is available on mobile and desktop platforms,
                ensuring flexibility for users who need to edit images on the go
                or from their workstations.
              </p>
        ...
        `}
          ...
          <div className="bg-primary text-center text-light rounded-4 p-5 mt-5">
            <h4 className="mb-3">Ready to get started with ClipDrop AI ?</h4>
            <p className="mb-4">
