        ...
        <div className="container">
          <div className=" row d-flex align-items-center justify-content-between mb-1">
            ...
            >
              ...
              <h1>Canva AI: The Magic Studio</h1>
              ...
              <p>
                ...
                content with ease. From AI-generated images to smart writing
                assistants, Canva AI aims to make graphic design and content
                creation accessible for everyone—whether you're a professional,
          ...
          <div className="bg-primary text-center text-light rounded-4 p-5 mt-5">
            <h4 className="mb-3">Ready to get started with CanvaAI?</h4>
            <p className="mb-4">
