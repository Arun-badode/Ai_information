...
import findmine from '../../../../public/assets/Img/AI for E-commerce/findmine.png'
import findmine1 from '../../../../public/assets/Img/AI for E-commerce/findmine1.png'
import findmine2 from '../../../../public/assets/Img/AI for E-commerce/findmine2.png'
...
const FindMineAI = () => {
  ...
  <div className="row align-items-center g-4 g-lg-5 mb-4">
    ...
    <div className="col-lg-6 col-12 order-lg-1 order-2 pe-lg-4">
      ...
      <h1 className="display-6 mb-3">FindMine AI</h1>
    ...
    <div className="col-lg-6 col-12 order-lg-2 order-1">
      <div className="ratio ratio-16x9 bg-light rounded-3 overflow-hidden p-2">
        <img
          src={findmine}
          alt="FindMine AI Platform"
